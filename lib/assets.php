...
function assets() {
  ...
  wp_localize_script( 'sage_js', 'campchaser_ajax_vars', array(
          'campchaser_ajax_nonce' => wp_create_nonce( 'campchaser_ajax_nonce' ),
          'campchaser_ajax_url' => admin_url( 'admin-ajax.php' ),
    )
  );
}
